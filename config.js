...
module.exports = {
  ...
  // رسائل البوت
  messages: {
    welcome: 'مرحباً بك في بوت التواصل مع الإدارة. أرسل رسالتك وسنرد عليك في أقرب وقت.',
    messageSent: 'تم إرسال رسالتك إلى الإدارة، وسيتم الرد عليك قريباً.',
